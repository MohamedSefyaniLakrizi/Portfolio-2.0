<template>
  <NuxtLink :to="props.link">
    <div
      class="relative w-full rounded-xl overflow-hidden group hover:scale-[1.02] transition-all duration-300 ease-in-out">
      <img :src="props.image" :alt="props.alt" class="w-full rounded-xl" />
      <div
